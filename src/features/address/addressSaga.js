...
const fetchAddressesAPI = async () => {
  ...
  const response = await fetch("http://192.168.1.9:8081/api/address/get", {
...
const addAddressAPI = async (addressData) => {
  ...
  const response = await fetch("http://192.168.1.9:8081/api/address/add", {
    method: "POST",
    headers: {
...
const updateAddressAPI = async (addressId, updatedData) => {
  ...
  const token = localStorage.getItem("authToken");
  const response = await fetch(`http://192.168.1.9:8081/api/address/updateaddress/${addressId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
...
const deleteAddressAPI = async (addressId) => {
  ...
  const response = await fetch(
    `http://192.168.1.9:8081/api/address/delete/${addressId}`,
    {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    }
