...
const fetchBestSellingProductsApi = async () => {
  try {
    const response = await fetch("http://192.168.1.25:8081/api/dashboard/products/best-selling");
...
const fetchTopCustomersApi = async () => {
  const response = await fetch("http://192.168.1.25:8081/api/dashboard/customers/top");
