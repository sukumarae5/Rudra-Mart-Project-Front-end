...
const ExploreOurProductspage = () => {
  ...
  return (
    <Container fluid style={{ marginTop: "30px", marginBottom: "30px" }}>
      <h2 style={{ fontWeight: "bold", marginBottom: "10px", color: "#0033A0", fontSize: "30px" }}>
        All Products
      </h2>
      ...
      <Row>
        {loading ? (
          ...
          products.map((product) => (
            <Col key={product.id} xs={12} sm={6} md={4} lg={2} style={{ marginBottom: "20px" }}>
              <Card
              ...
              >
                <div style={{ position: "relative", width: "100%", paddingBottom: "100%" }}>
                  {product.discount ? (
                    <div className="position-absolute top-0 start-0 bg-warning text-dark px-2 py-1 rounded">
                ...
                <Card.Body className="text-center d-flex flex-column justify-content-between">
                  ...
                  <Card.Text>{product.weight || product.quantity}</Card.Text>
                  <Card.Text>
