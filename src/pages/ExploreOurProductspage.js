...
const ProductCard = ({ product, hoveredCard, setHoveredCard, handleCardClick, handleWishlistClick, clickedProducts, handleAddToCart }) => {
        ...
        >
            ...
            >
                {clickedProducts.has(product.id) ? (
                    <FaHeart style={{ fontSize: "1.5rem", color: "red", cursor: "pointer" }} onClick={(e) => handleWishlistClick(e, product)} />
                ) : (
